...
// Unused in current build; forward declarations can trigger -Wunused-function with Clang when set as errors.
// Commented out to avoid build break. Re-enable alongside their definitions if used again.
