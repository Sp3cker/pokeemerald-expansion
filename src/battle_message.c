...
extern bool8 sShowOriginalNames;
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
    {
        ...
        [STRINGID_COMMANDERACTIVATES -
            BATTLESTRINGS_TABLE_START] = sText_CommanderActivates,
        ...
        [STRINGID_PKMNFROSTBITTENBY -
            BATTLESTRINGS_TABLE_START] = sText_PkmnFrostbittenBy,
        ...
        [STRINGID_ATTACKERACQUIREDABILITY -
            BATTLESTRINGS_TABLE_START] = sText_AttackerAcquiredAbility,
        ...
        [STRINGID_PKMNMAKESROCKMISS -
            BATTLESTRINGS_TABLE_START] = sText_PkmnMakesRockMiss,
        ...
        [STRINGID_SUNLIGHTISHARSH -
            BATTLESTRINGS_TABLE_START] = sText_SunlightIsHarsh,
        [STRINGID_ITISHAILING -
            BATTLESTRINGS_TABLE_START] = sText_ItIsHailing,
        [STRINGID_ITISSNOWING -
            BATTLESTRINGS_TABLE_START] = sText_ItIsSnowing,
        [STRINGID_ISCOVEREDWITHGRASS -
            BATTLESTRINGS_TABLE_START] = sText_IsCoveredWithGrass,
        [STRINGID_MISTSWIRLSAROUND -
            BATTLESTRINGS_TABLE_START] = sText_MistSwirlsAround,
        [STRINGID_ELECTRICCURRENTISRUNNING -
            BATTLESTRINGS_TABLE_START] = sText_ElectricCurrentIsRunning,
        [STRINGID_SEEMSWEIRD -
            BATTLESTRINGS_TABLE_START] = sText_SeemsWeird,
        [STRINGID_WAGGLINGAFINGER -
            BATTLESTRINGS_TABLE_START] = sText_WagglingAFinger,
        [STRINGID_BLOCKEDBYSLEEPCLAUSE -
            BATTLESTRINGS_TABLE_START] = sText_BlockedBySleepClause,
        [STRINGID_GRIPPERACTIVATES -
            BATTLESTRINGS_TABLE_START] = sText_GripperActivates,
};
...
static void GetBattlerNick(u32 battler, u8 *dst)
{
    ...
    if (sShowOriginalNames && gBattleMons[battler].originalSpecies != SPECIES_NONE)
    {
        StringCopy(dst, GetSpeciesName(gOriginalSpecies));
    }
    else
    {
